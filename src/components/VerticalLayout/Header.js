                    ...
                    <div className="navbar-header">
                        <div className="d-flex">
                            ...
                            <div className="navbar-brand-box">
                                ...
                                <h5 className="logo-sm text-light text-center mt-3">
                                        {/* <img src={logosmlight} alt="" height="22" /> */}
                                        {/* <Link to="/feastwell-frontend/dashboard" className="text-light text-center mt-3"> CM</Link> */}
                                    </h5>
                                    <h4 className="logo-lg text-light text-center mt-3">
                                       {/* <Link to="/feastwell-frontend/dashboard" className="text-light text-center mt-3"> Company</Link> */}
